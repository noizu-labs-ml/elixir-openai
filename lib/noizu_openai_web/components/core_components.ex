defmodule NoizuLabs.OpenAIWeb.CoreComponents do
  @moduledoc """
  ...
  def translate_error({msg, opts}) do
    ...
    if count = opts[:count] do
      Gettext.dngettext(NoizuLabs.OpenAIWeb.Gettext, "errors", msg, msg, count, opts)
    else
      Gettext.dgettext(NoizuLabs.OpenAIWeb.Gettext, "errors", msg, opts)
    end
  end
